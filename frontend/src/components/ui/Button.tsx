...
const variants: Record<Variant, string> = {
  primary:
    'bg-[var(--brand)] text-[var(--brand-fg)] hover:brightness-110 shadow-glow font-semibold',
  secondary:
  ...
  outline:
    'border border-[var(--border)] bg-transparent text-[var(--fg)] hover:border-[var(--brand)] hover:text-[var(--brand-text)]',
}
