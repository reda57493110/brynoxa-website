export const en = {
  ...
  shop: {
    ...
    filterNote: 'Cash on delivery · prices in DH · 6-month warranty',
  ...
  orders: {
    ...
    kicker: 'Account',
    heading: 'Orders',
    listBody: 'Track every cash-on-delivery purchase. Pending orders can be cancelled from the order page.',
  ...
  contact: {
    ...
    channelsTitle: 'WhatsApp, phone, or email',
